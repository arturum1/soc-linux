...
let
  py2hwsw_commit = "4459f67afe8df4aa8d7701bdc4d99f9e5e09fa0d"; # Replace with the desired commit.
  py2hwsw_sha256 = "AEDn8d5XTOKCqsGY1K1Z+tJzcILOLX1VeHgAPUk+G6k="; # Replace with the actual SHA256 hash.
