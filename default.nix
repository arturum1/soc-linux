...
let
  py2hwsw_commit = "6787100624d4d524db2a667d06893dda5a409fda"; # Replace with the desired commit.
  py2hwsw_sha256 = "OyrxMGBGu4mUmRdQu9fCbO9Bgrfjtmiu4j6mAFTc4wo="; # Replace with the actual SHA256 hash.
